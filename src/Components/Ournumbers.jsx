...
import { Bus } from "lucide-react"; // I'll assume you're using this icon, as provided in your code

// A custom hook to animate numbers when they become visible
...
function Ournumbers() {
    // Hooks for each number with corrected values from previous discussions
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('https://images.unsplash.com/photo-1503376780353-7e6692767b70?ixlib=rb-4.0.3&auto=format&fit=crop&w=1650&q=80')`,
            }}
        >
            {/* Overlay is now part of the backgroundImage style */}
                    ...
                    {stats.map((stat, index) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center">
                                <p className="text-3xl font-bold text-yellow-400">{stat.value.toLocaleString()}{stat.suffix}</p>
                                <p className="text-gray-200 text-sm mt-1 text-center" dangerouslySetInnerHTML={{ __html: stat.label }}></p>
                            </div>
                        </div>
                    ))}
                </div>
