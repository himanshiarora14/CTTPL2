  ...
  return (
    <section className="max-w-4xl mx-auto text-center  py-12">
      ...
      <p className="text-md text-gray-800 leading-relaxed">
        ...
        in corporate and public transportation, offering a wide range of services—from employee
        and school transport to car leasing and sustainable electric fleets. Our story is one of
        growth, driven by a mission to contribute positively to the communities we serve and to set
