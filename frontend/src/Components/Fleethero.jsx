...
export default function Fleethero() {
  return (
      ...
      paragraph="From luxury sedans to economy cars and premium coaches, CTTPL offers a wide range of vehicles — choose comfort, safety, and reliability for every journey."
      image={bus2}
    />
